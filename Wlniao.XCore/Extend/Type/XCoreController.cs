...
namespace Wlniao
{
    ...
    public class XCoreController : Controller
    {
        ...
        /// 当前请求是否安全
        /// </summary>
        protected Boolean RequestSecurity = true;
        /// <summary>
        /// 
        /// </summary>
