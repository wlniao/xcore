...
namespace Wlniao.Net.Dns
{
    ...
    /// NAPTR record class.
    /// </summary>
    internal class DnsRecord_NAPTR : DnsRecord
    {
        ...
        public DnsRecord_NAPTR(string name, int order, int preference, string flags, string services, string regexp, string replacement, int ttl) : base(name,DnsRecordType.NAPTR,ttl)
        {
            m_Order = order;
