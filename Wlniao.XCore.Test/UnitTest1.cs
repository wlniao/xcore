...
namespace Wlniao.XCore.Test
{
    public class Tests
    {
        ...
        public void Test1()
        {
            var str = Wlniao.XServer.Common.GetResponseString("http://jinke.qihui365.com/login");
        ...
        public void Test2()
        {
            var str = Wlniao.XServer.Common.GetResponseString("http://jinke.qihui365.com/js/md5.js");
            var length = str.Length;
            Assert.GreaterOrEqual(length, 0);
            //Assert.Pass();
        }
        ...
        public void Test3()
        {
            var str = Wlniao.XServer.Common.GetResponseString("http://wx.jeffhouse.net/js/chunk-vendors.js?v=2105182354");
            var length = str.Length;
